...
def setup_best_config(
    ...
    if exp_name == "model-experiments":
        ...
        exp.last_layer_activation = (
            best_experiment_config.last_layer_activation
        )
...
def add_classifier_head(
    ...
    if exp.classifier_head == "default":
        ...
        # Average the outputs
        ensemble_output = Average()([predictions1, predictions2, predictions3])

        # Create the model
        model = Model(inputs=base_model.input, outputs=ensemble_output)
